...
const Tailwind = () => {
    return (
        <div className="grid-cols-4 grid-rows-4 min-h-screen row-span-full">
        <header className="bg-gray-100"> 
            <section className="container mx-auto px-4"> 
                <div className="flex flex-wrap -mx-4 items-center py-6 justify-between"> 
                    <div className="px-4 py-1 space-x-1"> 
                        <a href="#" className="font-medium hover:text-purple-400 mr-auto text-3xl text-purple-400 uppercase">AK&nbsp;</a> 
                    </div>                                          
                </div>                 
            ...
            <nav className="flex items-center flex-wrap px-4  container mx-auto py-2 justify-between"> 
                <button className="hover:text-purple-700 px-3 py-2 rounded text-purple-400 lg:hidden" data-name="nav-toggler" data-pg-ia='{"l":[{"name":"NabMenuToggler","trg":"click","a":{"l":[{"t":"^nav|[data-name=nav-menu]","l":[{"t":"set","p":0,"d":0,"l":{"class.remove":"hidden"}}]},{"t":"#gt# span:nth-of-type(1)","l":[{"t":"tween","p":0,"d":0.2,"l":{"rotationZ":45,"yPercent":300}}]},{"t":"#gt# span:nth-of-type(2)","l":[{"t":"tween","p":0,"d":0.2,"l":{"autoAlpha":0}}]},{"t":"#gt# span:nth-of-type(3)","l":[{"t":"tween","p":0,"d":0.2,"l":{"rotationZ":-45,"yPercent":-300}}]}]},"pdef":"true","trev":"true"}]}'> 
                ...
                <div className="lg:flex lg:items-center lg:space-x-4 lg:space-y-0 lg:w-auto space-y-2 w-full hidden" data-name="nav-menu"> 
                    <div className="flex flex-col lg:flex-row  ml-0">
                        <a href="#" className="font-light hover:text-purple-400 px-0 py-2 uppercase lg:px-4">Home</a> 
                        <a href="#" className="font-light hover:text-purple-400 px-0 py-2 uppercase lg:px-4">Portfolio</a> 
                        <a href="#" className="font-light hover:text-purple-400 px-0 py-2 uppercase lg:px-4">Blog</a> 
                        <a href="#" className="font-light hover:text-purple-400 px-0 py-2 uppercase lg:px-4">About</a> 
                        <a href="#" className="font-light hover:text-purple-400 px-0 py-2 uppercase lg:px-4">Contact</a>
                    </div>                     
                </div>                 
            </nav>             
        </header>
            ...
            <section className="bg-gray-50 py-20 text-gray-500"> 
                <div className="container mx-auto px-4"> 
                    <div className="flex flex-wrap -mx-4  items-center"> 
                        <div className="ml-auto p-4 w-full lg:order-2 lg:w-6/12"> 
                            <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 876.272 661.473" className="h-auto max-w-full w-full">
                                ...
                                <path d="M660.796 169.203h-545.84v-8.4a16.574 16.574 0 0116.56-16.55h512.72a16.574 16.574 0 0116.56 16.55z" fill="#007bff"/>
                                ...
                                <path d="M389.61 385.58h-16a1 1 0 010-2h16a1 1 0 010 2zM389.61 391.58h-16a1 1 0 010-2h16a1 1 0 010 2zM389.61 397.58h-16a1 1 0 010-2h16a1 1 0 010 2zM505.11 421.58h-43a9.51 9.51 0 01-9.5-9.5v-43a9.51 9.51 0 019.5-9.5h43a9.51 9.51 0 019.5 9.5v43a9.51 9.51 0 01-9.5 9.5zm-43-60a7.508 7.508 0 00-7.5 7.5v43a7.508 7.508 0 007.5 7.5h43a7.508 7.508 0 007.5-7.5v-43a7.508 7.508 0 00-7.5-7.5z" fill="#ccc"/>
                                ...
                                <path d="M821.951 660.034l-39.53-.002v-.5a15.386 15.386 0 0115.386-15.386h.001l24.144.001zM815.15 627.65l-11.355-3.454a4.493 4.493 0 01-3.166-3.833l-10.585-100.326a.48.48 0 00-.479-.447.47.47 0 00-.51.409l-17.731 97.2a4.5 4.5 0 01-5.335 3.599l-14.512-2.99a4.516 4.516 0 01-3.581-4.711l10.785-159.313 73.138-7.891-10.868 177.726a4.505 4.505 0 01-4.484 4.228 4.526 4.526 0 01-1.317-.197z" fill="#2f2e41"/>
                                <circle cx="815.08" cy="290.487" r="24.561" fill="#ffb8b8"/>
                                <path d="M758.568 454.72l15.859-99.851a37.857 37.857 0 0148.005-30.4 37.743 37.743 0 0126.601 43.262l-16.591 89.172z" fill="#007bff"/>
                                ...
                                <path d="M825.372 451.665a4.506 4.506 0 01-2.427-1.15l-6.273-5.797a4.515 4.515 0 01-1.092-5.055l12.538-29.718-1.779-58.72a14.497 14.497 0 1128.727 3.92l3.041 36.911a46.373 46.373 0 01-8.938 31.397l-19.552 26.432a4.505 4.505 0 01-3.195 1.804 4.455 4.455 0 01-1.05-.024z" fill="#007bff"/>
                                ...
                                <path d="M691.537 288.495a4.506 4.506 0 012.006-1.786l7.783-3.516a4.515 4.515 0 015.08.965l22.478 23.132 54.767 21.256a14.497 14.497 0 11-14.81 24.926l-35.176-11.591a46.374 46.374 0 01-25.427-20.472l-16.718-28.31a4.505 4.505 0 01-.415-3.646 4.454 4.454 0 01.432-.958z" fill="#007bff"/>
                                ...
                                <path d="M604.056 131.912a11.22 11.22 0 00-7.25-5.1 10.301 10.301 0 00-1.66-.21l-76.19-68.12a9.015 9.015 0 00-5.63-2.69 7.67 7.67 0 00-1.27-.04 9.055 9.055 0 00-5.96 15.48l29.17 25.43 47.9 41.75a11.916 11.916 0 00.35 2.33 11.266 11.266 0 009.67 8.37 11.092 11.092 0 006.05-1 11.407 11.407 0 003.88-2.97c.11-.13.21-.25.31-.39a11.293 11.293 0 00.63-12.84zM473.736 197.562l-.71-28.86-.6-23.95-.41-16.76-.81-32.67a9.046 9.046 0 00-15.71-5.25 6.923 6.923 0 00-.75.96 8.936 8.936 0 00-1.56 6.05l1.78 47.67.89 23.95 1.14 30.55a12.047 12.047 0 00-.89 1.41 11.248 11.248 0 00-.71 8.84 11.311 11.311 0 0015.56 6.63 11.3 11.3 0 002.78-18.57z" fill="#ffb8b8"/>
                                ...
                                <path d="M158.051 310.732q.343.273.664.578a10.38 10.38 0 01-.417 15.484 9.722 9.722 0 01-.814.613l1.569 52.945a8.061 8.061 0 01-5.545 7.867l-.096.02-42.989 4.579a8.899 8.899 0 11-1.722-17.713l30.644-2.7 5.3-45.85a9.876 9.876 0 01-.971-.99 10.38 10.38 0 0114.377-14.833zM139.328 649.174h11.567l5.502-44.613h-17.071l.002 44.613z" fill="#a0616a"/>
                                ...
                                <path d="M189.11 314.973h-28a3.003 3.003 0 01-3-3v-21a3.003 3.003 0 013-3h7.883a2.981 2.981 0 012.555 1.427l2.198 3.573h15.364a3.003 3.003 0 013 3v16a3.003 3.003 0 01-3 3z" fill="#007bff"/>
                        ...
                        <div className="p-4 w-full lg:order-1 lg:w-5/12">                              
                            <h2 className="font-bold mb-2 text-4xl text-gray-800">We Work Together To Play, Have Fun, Design And Create</h2> 
                            <p className="mb-6">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam vitae congue tortor.</p> 
                            <a href="#" className="bg-purple-400 hover:bg-purple-600 inline-block px-5 py-2 rounded text-white">Read More</a> 
                        </div>                         
                    </div>                     
                </div>                 
            </section>
        </div>
        <footer className="bg-gray-50 flex-col font-light items-center justify-center pt-12 text-gray-500"> 
            <div className="-mx-4 flex flex-col-reverse">
                ...
                <div className="flex-wrap inline-flex self-center space-x-3"> 
                    <a href="#" className="hover:text-blue-600"> <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 hover:text-purple-400 w-5"> 
                            <path d="M14 13.5h2.5l1-4H14v-2c0-1.03 0-2 2-2h1.5V2.14c-.326-.043-1.557-.14-2.857-.14C11.928 2 10 3.657 10 6.7v2.8H7v4h3V22h4v-8.5z"/> 
                        </svg></a> 
                    <a href="#" className="hover:text-blue-600"> <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 hover:text-purple-400 w-5"> 
                            <path d="M22.162 5.656a8.384 8.384 0 0 1-2.402.658A4.196 4.196 0 0 0 21.6 4c-.82.488-1.719.83-2.656 1.015a4.182 4.182 0 0 0-7.126 3.814 11.874 11.874 0 0 1-8.62-4.37 4.168 4.168 0 0 0-.566 2.103c0 1.45.738 2.731 1.86 3.481a4.168 4.168 0 0 1-1.894-.523v.052a4.185 4.185 0 0 0 3.355 4.101 4.21 4.21 0 0 1-1.89.072A4.185 4.185 0 0 0 7.97 16.65a8.394 8.394 0 0 1-6.191 1.732 11.83 11.83 0 0 0 6.41 1.88c7.693 0 11.9-6.373 11.9-11.9 0-.18-.005-.362-.013-.54a8.496 8.496 0 0 0 2.087-2.165z"/> 
                        </svg></a> 
                    <a href="#" className="hover:text-blue-600"> <svg viewBox="0 0 24 24" fill="currentColor" class="h-5 hover:text-purple-400 w-5"> 
                    ...
                    <a href="#" className="hover:text-purple-400"> <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5"> 
