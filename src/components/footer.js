...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-50 flex-col font-light items-center justify-center pt-12 text-gray-500 p-4 pin-b w-full">
      <div className="-mx-4 flex flex-col-reverse">
        <div className="py-4 text-sm">
          <hr className="border-gray-400 mb-4" />
          <div className="-mx-4 flex flex-wrap items-center justify-center">
            <p> 2021 by Andrew Kepson</p>
          </div>
        </div>
        <div className="flex-wrap inline-flex self-center space-x-4">
          ...
          >
            ...
            <svg
              viewBox="0 0 24 24"
              fill="currentColor"
              className="h-5 hover:text-purple-400 w-5"
            >
